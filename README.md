...
Step 1: Launch the following AWS CloudFormation template to deploy ELB and EC2 instance to host the webapp.
---------------------------------------------------------------------
...
Step 6 : Streamlit app will prompt to **Connect auth0**. Use the same email id and password for the user that is already exist in IAM Identity Center.
